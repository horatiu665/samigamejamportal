namespace HhhNetwork.Build.Editor
{
    ...
    public static class BuildScriptPrefs
    {
        ...
        public static void SetCurrentMode(BuildMode mode)
        {
            EditorPrefs.SetInt(_keyCurrentMode, (int)mode);
        }

        public static BuildMode GetCurrentMode()
        {
            return (BuildMode)(EditorPrefs.GetInt(_keyCurrentMode, (int)BuildMode.Singleplayer));
        }
